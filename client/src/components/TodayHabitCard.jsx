    ...
    >
      ...
      <button
        ...
        className={`shrink-0 w-11 h-11 rounded-full flex items-center justify-center transition ${completed
          ...
          : "bg-brand-500/10 border-2 border-brand-400/50 text-brand-500 hover:border-brand-500 hover:bg-brand-500/20 dark:bg-brand-500/10 dark:border-brand-400/40 dark:text-brand-300"
          }`}
