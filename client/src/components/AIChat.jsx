...
export default function AIChat() {
  ...
  return (
    <>
      <button
        onClick={() => setOpen((o) => !o)}
        className="fixed bottom-[72px] md:bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-gradient-to-br from-brand-500 to-brand-700 text-white shadow-2xl shadow-brand-500/40 flex items-center justify-center hover:scale-105 active:scale-95 transition"
        aria-label="AI Chat"
      >
      ...
      {open && (
        <div className="fixed bottom-[140px] md:bottom-24 right-6 z-40 w-[min(92vw,380px)] h-[min(60vh,500px)] glass-strong rounded-2xl flex flex-col animate-slide-up shadow-2xl overflow-hidden">
